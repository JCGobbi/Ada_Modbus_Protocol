...
package Serial_IO.Blocking is
   ...
   function Get_Serial_Mode (This : in out Serial_Port) return Serial_Modes with
     Inline;

   --  This procedure was created for MODBUS
   procedure Set_Serial_Mode (This : in out Serial_Port; To : Serial_Modes) with
     Post => Get_Serial_Mode (This) = To,
     Inline;
   ...
   --  This procedure was created for MODBUS
   procedure Set_InterChar_Timeout (This : in out Serial_Port; To : Time_Span) with
     Inline;

   --  This procedure was created for MODBUS
   procedure Set_InterFrame_Timeout (This : in out Serial_Port; To : Time_Span) with
     Inline;

   --  This procedure was created for MODBUS
   procedure Set_Response_Timeout (This : in out Serial_Port;
                                   To : Time_Span := Time_Span_Last) with
     Inline;
