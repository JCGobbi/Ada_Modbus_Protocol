package body Message_Buffers is
   ...
   procedure Note_Error (This      : in out Message;
                         Condition : Error_Conditions)
   is
   begin
   ...
   procedure MBus_Set_Mode (This : in out Message;
                            To   : MBus_Modes)
   is
   begin
   ...
   function MBus_Has_Error (This      : Message;
                            Condition : MBus_Error_Conditions) return Boolean
   is
   begin
