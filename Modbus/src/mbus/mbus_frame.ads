...
package MBus_Frame is
   ...
   --  Takes a pair of chars starting at 2nd position of buffer for modbus ASCII
   --  with high-order byte before low-order byte.
   ...
   procedure MBus_Append_Data (This : in out Message;  To : UInt8) with
     Post => (if MBus_Get_Mode (This) = RTU then
                 ...
                 MBus_Get_Data_At (This, (Get_Length (This) - 1) / 2) = To);
