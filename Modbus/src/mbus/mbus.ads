...
package MBus is
   ...
   No_Error               : constant MBus_Error_Conditions := 2#0000_0000#; --  16#00#
   Invalid_Address        : constant MBus_Error_Conditions := 2#0000_0001#; --  16#01#
   Invalid_Function_Code  : constant MBus_Error_Conditions := 2#0000_0010#; --  16#02#
   Invalid_Checking       : constant MBus_Error_Conditions := 2#0000_0100#; --  16#04#
   Invalid_Parity         : constant MBus_Error_Conditions := 2#0000_1000#; --  16#08#
   InterChar_Timed_Out    : constant MBus_Error_Conditions := 2#0001_0000#; --  16#10#
   InterFrame_Timed_Out   : constant MBus_Error_Conditions := 2#0010_0000#; --  16#20#
   Response_Timed_Out     : constant MBus_Error_Conditions := 2#0100_0000#; --  16#40#
   Invalid_Frame          : constant MBus_Error_Conditions := 2#1000_0000#; --  16#80#
